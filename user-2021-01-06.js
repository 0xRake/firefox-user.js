...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1610636407);
...
user_pref("browser.cache.offline.capacity", 16384);
...
user_pref("browser.newtabpage.activity-stream.discoverystream.region-stories-block", "US");
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1610636381558");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1610638202558");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1610636382913");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1610657982913");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1610636378");
...
user_pref("browser.startup.lastColdStartupCheck", 1610636378);
...
user_pref("captivedetect.maxRetryCount", 1);
...
user_pref("devtools.responsive.viewport.width", 1333);
...
user_pref("devtools.toolbox.splitconsoleHeight", 238);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1610636409);
...
user_pref("network.connectivity-service.DNSv4.domain", "skip");
user_pref("network.connectivity-service.DNSv6.domain", "skip");
...
user_pref("places.history.expiration.transient_current_max_pages", 51301);
...
user_pref("print.printer__.print_paper_id", "na-letter");
...
user_pref("services.settings.main.nimbus-desktop-experiments.last_check", 1610605591);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1598585534);
user_pref("services.settings.main.password-recipes.last_check", 1610324013);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1610324013);
...
user_pref("services.settings.main.search-telemetry.last_check", 1610324013);
user_pref("services.settings.main.sites-classification.last_check", 1598585534);
user_pref("services.settings.main.top-sites.last_check", 1610324013);
...
user_pref("toolkit.startup.last_success", 1610636376);
